...
function FragmentTypesExplorer({ client, onDataFetch, isLoading, setIsLoading, setError }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await client.request('/jsonapi/nodehive_fragment_type/nodehive_fragment_type');
        ...
        <div className="space-y-4">
          <div className="card p-4">
            ...
            <p className="text-xs text-muted-foreground">
              Fragment types define the different kinds of fragments available in your NodeHive system.
...
export default FragmentTypesExplorer;
